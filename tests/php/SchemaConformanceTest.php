...
class SchemaConformanceTest extends TestCase
{
    ...
    private const PENDING_MIGRATION = [
        ...
        'invoices.scholarship_amount'     => '102_invoice_scholarship.sql',
        'invoices.scholarship_label'      => '102_invoice_scholarship.sql',
        'invoices.scholarship_reason'     => '102_invoice_scholarship.sql',
        'invoices.scholarship_id'         => '102_invoice_scholarship.sql',
        'invoices.scholarship_awarded_by' => '102_invoice_scholarship.sql',
        'invoices.scholarship_awarded_at' => '102_invoice_scholarship.sql',
    ];
