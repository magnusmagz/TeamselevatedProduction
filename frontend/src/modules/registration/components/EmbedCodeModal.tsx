        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex space-x-2">
              ...
              <button
                onClick={copyLink}
                className="bg-forest-800 text-white border border-forest-800 rounded-md px-4 py-2 hover:bg-forest-700 uppercase text-sm font-semibold"
              >
                {copied ? 'Copied!' : 'Copy'}
              </button>
            </div>
          ...
          <div className="mb-6">
            ...
            <button
              ...
              className="mt-2 bg-forest-800 text-white border border-forest-800 rounded-md px-6 py-2 hover:bg-forest-700 uppercase font-semibold"
            >
