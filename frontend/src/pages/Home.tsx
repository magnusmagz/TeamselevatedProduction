    ...
    <div className="min-h-screen bg-gradient-to-b from-forest-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="space-y-4">
            <div className="space-x-4">
              <Link
                to="/get-started"
                className="inline-block bg-forest-600 hover:bg-forest-700 text-white font-semibold py-3 px-8 rounded-md transition-colors duration-200"
              >
                Get Started
              </Link>
              <Link
                to="/login"
                className="inline-block bg-white hover:bg-gray-50 text-forest-600 font-semibold py-3 px-8 border-2 border-forest-600 rounded-md transition-colors duration-200"
              >
                Sign In
              </Link>
            </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white shadow-sm border border-forest-200 rounded-md p-6">
            <div className="w-12 h-12 bg-forest-100 rounded-md flex items-center justify-center mb-4">
