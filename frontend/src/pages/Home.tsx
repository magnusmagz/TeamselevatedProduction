      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="space-y-4">
            <div className="space-x-4">
              <Link
                to="/get-started"
                className="inline-block bg-brand-primary hover:bg-brand-primary text-white font-semibold py-3 px-8 transition-colors duration-200"
              >
                Get Started
              </Link>
              <Link
                to="/login"
                className="inline-block bg-white hover:bg-gray-50 text-brand-primary font-semibold py-3 px-8 border-2 border-brand-primary transition-colors duration-200"
              >
                Sign In
              </Link>
            </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white shadow-sm border-2 border-gray-200 p-6">
            <div className="w-12 h-12 bg-brand-secondary flex items-center justify-center mb-4">
