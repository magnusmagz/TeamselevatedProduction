            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {teams.map((team) => (
                  <div
                    key={team.id}
                    className="bg-white border border-forest-200 p-6 hover:bg-gray-50 cursor-pointer transition-colors"
                  ...
                  >
                    ...
                    <button className="w-full mt-4 bg-forest-800 text-white border border-forest-200 py-2 hover:bg-forest-700 uppercase">
                      Manage Roster →
                    </button>
                  </div>
                ))}
