...
const ExpirationDashboard: React.FC = () => {
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-forest-800 mb-2 uppercase tracking-wide">Document Dashboard</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {groups.expired.length > 0 && (
          <div className="p-6 border-2 border-red-600 bg-red-50 rounded-md">
      ...
      {expiringDocs.length === 0 && (
        <div className="p-12 text-center bg-green-50 border-2 border-green-600 rounded-md">
