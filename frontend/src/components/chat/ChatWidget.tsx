    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {!isExpanded && (
        <button
          ...
          className="w-14 h-14 bg-forest-600 hover:bg-forest-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-105"
      ...
      {isExpanded && (
        <div className="w-96 h-[32rem] bg-white rounded-lg shadow-2xl border border-forest-200 flex flex-col overflow-hidden">
          {/* Header */}
