        ...
        case 'tournament-by-slug':
            ...
            $stmt = $db->prepare("
                SELECT t.id, t.name, t.description, t.sport, t.start_date, t.end_date,
                       ...
                       v.parking_notes AS venue_parking_notes,
                       v.gate_code AS venue_gate_code,
                       v.latitude AS venue_latitude,
                       v.longitude AS venue_longitude,
                       v.gm_contact_name  AS venue_contact_name,
                       v.gm_contact_phone AS venue_contact_phone,
                       v.gm_contact_email AS venue_contact_email,
                       v.medical_coordinator_name,
                       v.medical_coordinator_phone,
                       v.medical_coordinator_email,
                       v.medical_station_notes,
