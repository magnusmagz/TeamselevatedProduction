...
## Phase 4 — Identity: finish `user_guardians` (R6, crew-by-link empty portal) — 4.1, 4.1b, 4.2, 4.3 SHIPPED 2026-09-02 (Heroku v571, chat v26); 4.4 write links at source and 4.5 retire the email match remain
